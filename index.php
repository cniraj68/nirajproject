...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top">
      <a class="navbar-brand" href="http://localhost/project/feedback.php#"><b>MOJO</b></a>
      <button
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="images/1.jpg" alt="Field" width="1100" height="500" />
          <div class="carousel-caption">
            <h3>Farming</h3>
            <p></p>
          </div>
          ...
          <div class="col-lg-4 col-md-4 col-12">
            <div class="card shadow">
              ...
              <div class="card-body">
                ...
                <b>Harvesting</b> is the process of removal of entire plants or economic parts after maturity. The economic product may be grain, seed leaf, root. 
                </p>
...
$conn = mysqli_connect($servername,$username,$password,$dbname);
 ...
 {
  die("connection failed because = .mysqli_connect()");
 }
 	error_reporting(0);
       ...
       if($_POST['submit'])
       {
        ...
        if($rn!="" && $sn!="" && $cl!="" && $t!="")
        {
           ...
           $query = "INSERT INTO feedback  VALUES ('$rn','$sn','$cl','$t', CURRENT_TIMESTAMP)";
             $data = mysqli_query($conn, $query);

         if($data)
     {
   		 echo "<br><b><font color='green'> Feedback Submitted  Successfully";
     }
        }
        else
        {
          echo "<ont color='red'<br><b>Submitted Feild";
        }
       }
      ...
      ?>
        ...
        <form action="http://localhost/project/#feedback" method="post">
          ...
          <div class="form-group">
            ...
            <input type="email" name="email" autocomplete="off" required placeholder="example@gmail.com" class="form-control">
          </div>
        
       
          <div class="form-group">
            <label><b>Contact Number</b></label>
            <input type="number" name="number" autocomplete="off" required="number" placeholder="+977" class="form-control">
          </div>
       
          <div class="form-group">
            <label><b>Comment</b></label>
            <textarea class="form-control row-5" name="comment"  placeholder="Comments" required="">
            </textarea>
          </div>
