...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top">
      <a class="navbar-brand" href="#"><b>MOJO</b></a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active form-inline my-2 my-lg-2">
            <a class="nav-link" href="http://localhost/project/"
          ...
          <li class="nav-item my-2 my-lg-2">
            <a class="nav-link" href="http://localhost/project/#about"><b>About</b></a>
          </li>
          <li class="nav-item my-2 my-lg-2">
            <a class="nav-link" href="http://localhost/project/#feedback"><b>Feedback</b></a>
          </li>
        </ul>
